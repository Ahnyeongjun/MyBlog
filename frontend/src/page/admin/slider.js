...
const ManipulatingSwiper = () => {
    ...
    useEffect(() => {
        if (swiper !== null) {
            ...
            swiper.on('slideChangeTransitionStart', () => updateCurrentIndex(swiper.realIndex));
        }
    }, [swiper]);
    ...
    useEffect(() => {
        if (swiper !== null) {
            ...
            const isPaginationHidden = swiper.pagination.$el.hasClass(swiper.params.pagination.hiddenClass);

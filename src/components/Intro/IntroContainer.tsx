  ...
  slider.push(
    <SwiperSlide key={`slide-${i}`}>
      <img
        ...
        style={{ listStyle: "none", position: "static", display: "block" }}
        alt={`Slide ${i}`}
      />
    </SwiperSlide>
  );
